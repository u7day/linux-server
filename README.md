...
See project live at: [link](http://ec2-13-126-97-30.ap-south-1.compute.amazonaws.com/)
Notes for reviewer:
* public Ip: `http://13.126.97.30/`
* SSH PORT: `2200`
* Full project URL:[link](http://ec2-13-126-97-30.ap-south-1.compute.amazonaws.com/)
...
* Launch Amazon Lightsail terminal
    ...
    * Now Use the command `ssh -i ~/.ssh/key.pem ubuntu@13.126.97.30` to create the instance on your terminal
...
* Create SSH keys and copy to server manually:
    ...
    * login into grader account using password set during user creation `ssh -v grader@13.126.97.30 -p 2200`
...
.ssh/authorized_keys` paste contents(ctr+v)
    ...
    * save file(nano: `ctrl+x`, `Y`, Enter)
    * login with key pair: `ssh grader@13.126.97.30 -p 2200 -i ~/.ssh/item-catalog`
...
* Configure And Enable New Virtual Host
    ...
    * paste the following:
    ...
    ```
    <VirtualHost *:80>
      ServerName 13.126.97.30
      ServerAdmin admin@13.126.97.30
